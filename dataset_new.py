...
class MnliProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(
            self._read_jsonl(os.path.join(data_dir, "multinli_1.0_train.jsonl")), "train")
...
if __name__ == "__main__":
        ...
        sentset=NLIDataset('./multinli_1.0',tokenized=False,padding=False)

        BATCH=1
        contentloader=torch.utils.data.DataLoader(sentset,batch_size=BATCH,shuffle=True,num_workers=1)
        ...
        for idx,data in enumerate(contentloader):
                ...
                #print(type(sent1)) # tensor:  b * max_length
                print(sent1+sent2) # tensor:  b * max_length
