...
def albert_trainer(dataset_type="mnli", aum=True, filter=True,end_epoch=7):
    out_dir = "albert-{}-train-{}-filter-{}-{}_tmp".format(dataset_type, aum, filter,end_epoch)
...
if __name__ == "__main__":
    ...
    albert_trainer(dataset_type=args.dataset, aum=args.aum, filter=True, end_epoch=1)
